                    ...
                    <form action="{{ route('admin.konten.storeAdmin') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600">
                                        <label for="thumbnail"
                                            class="relative cursor-pointer bg-white rounded-md font-medium text-budanes hover:text-budanes-dark focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-budanes">
                        ...
                        <div class="flex justify-end space-x-4">
                            <a href="{{ route('konten.index') }}"
                                class="px-6 py-3 border border-gray-300 rounded-lg text-gray-700 font-medium font-poppins hover:bg-gray-50 transition-all">
                                Batal
                            </a>
                            <button type="submit"
                                class="border-b-4 border-black px-6 py-3 bg-budanes text-white rounded-lg font-medium font-poppins hover:shadow-lg transform hover:scale-105 transition-all duration-200">
                                Ajukan Konten
                            </button>
                        </div>
                    </form>
