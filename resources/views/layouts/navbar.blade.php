    ...
    <header class="sticky top-0 z-50" x-data="{
        ...
        <nav class="bg-white shadow-md transition-all duration-300" :class="{'shadow-lg': scrollPosition > 10}">
            <div class="container mx-auto px-4 py-3 flex justify-between items-center">
                <a href="/" class="inline-block transform hover:scale-105 transition-all duration-300">
                    <span class="text-3xl font-extrabold tracking-tighter bg-gradient-to-r from-dark to-darker text-transparent bg-clip-text font-lily">
                        Budaya
                    </span>
                    <span class="text-3xl font-extrabold tracking-tighter bg-gradient-to-r from-budanes to-budanes-dark text-transparent bg-clip-text font-lily">
                        Nesia
                    </span>
                </a>
